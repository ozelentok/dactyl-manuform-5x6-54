...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_5x6_54(
        ...
        OSM(MOD_LSFT),   LGUI_T(KC_A),    LALT_T(KC_S),    LSFT_T(KC_D),    LCTL_T(KC_F),    KC_G,                                                       KC_H,            LCTL_T(KC_J),    LSFT_T(KC_K),    LALT_T(KC_L),    LGUI_T(KC_SCLN), KC_QUOT,
    ...
    [SYM] = LAYOUT_5x6_54(
        ...
        KC_TRANSPARENT,  LGUI_T(KC_TAB),  LALT_T(KC_TAB),  LSFT_T(KC_GRAVE),LCTL_T(KC_MINUS),KC_UNDS,                                                    KC_LEFT,         LCTL_T(KC_DOWN), LSFT_T(KC_UP),   LALT_T(KC_RIGHT),LGUI_T(KC_PIPE), KC_TRANSPARENT,
        KC_TRANSPARENT,  KC_TRANSPARENT,  KC_ESC,          KC_TILD,         KC_EQL,          KC_PLUS,                                                    KC_HOME,         KC_PGDN,         KC_PGUP,         KC_END,          KC_TRANSPARENT,  KC_PAUSE,
                                                                            KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,           KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT
    ),
    [GAME] = LAYOUT_5x6_54(
        KC_ESC,          KC_1,            KC_2,            KC_3,            KC_4,            KC_5,                                                       KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
        ...
        KC_LSFT,         KC_A,            KC_S,            KC_D,            KC_F,            KC_G,                                                       KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
        KC_LCTL,         KC_Z,            KC_X,            KC_C,            KC_V,            KC_B,                                                       KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
                                                                            KC_LGUI,         KC_SPC,          LALT_T(KC_ESC),           KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT
